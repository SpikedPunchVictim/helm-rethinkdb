...
This repository is a copy of the [helm chart](https://github.com/helm/charts/blob/master/stable/rethinkdb/README.md), that uses a newer version of rethink.

# RethinkDB 2.4 Helm Chart
